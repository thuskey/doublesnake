...
- (void)drawRect:(CGRect)rect
{
    ...
    buttonOffset = 67.5f;
    //else buttonOffset = 52.5f; //Offset buttonOffset by half point for crisp lines
	CGContextSaveGState(context); //Save Context State Before Clipping "hatchPath"
	CGRect hatchFrame = CGRectMake(0.0f,activeBounds.size.height - buttonOffset, activeBounds.size.width, activeBounds.size.height);
