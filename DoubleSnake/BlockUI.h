...
#define kAlertViewTitleFont             [UIFont fontWithName:@"HelveticaNeue-CondensedBold" size:18]//[UIFont systemFontOfSize:18]
...
#define kAlertViewMessageFont           [UIFont fontWithName:@"HelveticaNeue-CondensedBold" size:18]//[UIFont systemFontOfSize:18]
...
#define kAlertViewButtonFont            [UIFont fontWithName:@"HelveticaNeue-CondensedBold" size:18]//[UIFont systemFontOfSize:18]
