...
@interface DoubleSnakeAlertView ()
...
@implementation DoubleSnakeAlertView
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        if (fillColor != nil) {
            //fillColor = [UIColor colorWithRed:(71/255.0) green:(77/255.0) blue:(87/255.0) alpha:0.5];
            //borderColor = [UIColor colorWithHue:0.625 saturation:0.0 brightness:0.8 alpha:0.5];
        }
    }
    return self;
}
...
- (void)drawRect:(CGRect)rect
{
	...
	CGRect backRect = CGRectMake(rect.origin.x + backOffset, 
                                 ...
                                 rect.size.height - backOffset*2-6);
